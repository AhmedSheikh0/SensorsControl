...
#define PORTB_PIN2_DIR         	STATE_INPUT
...
#define PORTC_PIN6_DIR          STATE_INPUT
#define PORTC_PIN7_DIR          STATE_INPUT

// PORT D Direction
#define PORTD_PIN0_DIR          STATE_INPUT
#define PORTD_PIN1_DIR          STATE_INPUT
#define PORTD_PIN2_DIR          STATE_INPUT
#define PORTD_PIN3_DIR          STATE_INPUT
#define PORTD_PIN4_DIR          STATE_INPUT
#define PORTD_PIN5_DIR          STATE_OUTPUT
#define PORTD_PIN6_DIR          STATE_INPUT
#define PORTD_PIN7_DIR          STATE_INPUT
...
#define PORTB_PIN2_INTIAL_VALUE     1
...
#define PORTD_PIN2_INTIAL_VALUE     1
